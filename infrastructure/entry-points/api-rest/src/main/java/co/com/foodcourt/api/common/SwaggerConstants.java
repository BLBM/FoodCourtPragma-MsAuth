...
public class SwaggerConstants {
    ...
    public static final String CREATE_EMPLOYEE_SUMMARY = "Create a new employee user";
    public static final String CREATE_EMPLOYEE_DESCRIPTION = "Creates a new user with the role EMPLOYEE. Only users with OWNERS role can perform this operation.";

    public static final String CREATE_CLIENT_SUMMARY = "Create a new client user";
    public static final String CREATE_CLIENT_DESCRIPTION = "Creates a new user with the role Client. Any users can use this action.";
